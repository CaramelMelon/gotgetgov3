...
export function OpenMatchCard({ openMatch, onJoinClick, onWatchClick }: OpenMatchCardProps) {
  const { host, distance, players } = openMatch;
      ...
      <div style={{ display: 'flex', gap: 6, flexShrink: 0 }}>
        ...
        {onWatchClick && (
          <button
            ...
            onMouseEnter={(e) => {
              e.currentTarget.style.background = 'var(--color-surf-3)';
            }}
            onMouseLeave={(e) => {
